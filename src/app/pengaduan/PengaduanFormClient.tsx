...
export default function PengaduanFormClient({ whatsappNumber }: { whatsappNumber: string }) {
  ...
  return (
    <div style={{ background: "#ffffff", padding: "2rem", borderRadius: "16px", border: "1px solid #e2e8f0", boxShadow: "0 4px 14px rgba(0,0,0,0.06)" }}>
      <h3 style={{ fontSize: "1.25rem", color: "#0f172a", marginBottom: "0.25rem" }}>📝 Formulir Pengaduan & Aspirasi</h3>
      <p style={{ fontSize: "0.85rem", color: "#64748b", marginBottom: "1.5rem" }}>
        Isi formulir di bawah ini untuk mengirimkan laporan resmi secara langsung.
      </p>

      {statusMsg && (
        <div style={{ background: "#ecfdf5", color: "#047857", border: "1px solid #a7f3d0", padding: "0.75rem 1rem", borderRadius: "8px", marginBottom: "1.25rem", fontSize: "0.875rem", fontWeight: 600 }}>
          {statusMsg}
        </div>
      )}
      ...
      <form onSubmit={handleSubmitWhatsApp}>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <textarea
            ...
            style={{ width: "100%", padding: "0.65rem 0.85rem", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "0.9rem", lineHeight: 1.6 }}
          />
        </div>
