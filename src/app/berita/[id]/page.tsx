  ...
  return (
    <section className="section">
      <div className="container" style={{ maxWidth: "820px" }}>
        ...
        <h1 style={{ fontSize: "2rem", color: "#0f172a", marginBottom: "0.75rem", lineHeight: 1.3, fontWeight: 700 }}>
          {item.judul}
        </h1>
        ...
        <img
          ...
          alt={item.judul}
          style={{ width: "100%", borderRadius: "14px", maxHeight: "420px", objectFit: "cover", marginBottom: "2rem", boxShadow: "0 4px 14px rgba(0,0,0,0.06)" }}
        />
